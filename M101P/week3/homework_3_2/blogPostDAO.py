...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        cursor = self.posts.find(filter={}, limit=num_posts, sort=[('date', pymongo.DESCENDING)]) 
    ...
    def get_post_by_permalink(self, permalink):
        ...
        # Fetch the post corresponding to the permalink. If it is not present,
        # find_one returns None.
        post = self.posts.find_one(filter={'permalink': permalink})
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            if post is not None:
                ...
                self.posts.update_one({'_id' : post['_id']}, { '$set' : { 'comments' : post['comments'] } })
                last_error['n'] = 1
